    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card">
            <div class="card-header bg-dark">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card_header"><i class="fa-brands fa-servicestack header_icon"></i> All Filter</h3>
                    </div>
                    <div class="col-md-4 text-end"><a href="{{ route('dashboard.filter.add') }}"
            ...
            <div class="row m-80">
                ...
                <div class="col-md-10">
                    <table class="table  table-striped text-center custom_table">
                        ...
                        <tbody>
                            @if($allfildata->count() > 0)
                                @foreach($allfildata as $data)
                                    <tr class="table_font">
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item"
                                                            href="{{ url ('dashboard/filter/view/'.$data->fil_slug) }}">View</a>
                                                    </li>

                                                    <li><a class="dropdown-item"
                                                            href="{{ url ('dashboard/filter/edit/'.$data->fil_slug) }}">Edit</a>
                                                    </li>
...
<div id="softDelete_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel"
    ...
    <div class="modal-dialog">
        <form method="post" action="{{ route ('dashboard.filter.softdelete') }}">
            @csrf
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-warning">
                    <h4 class="modal-title" id="primary-header-modalLabel">Filter</h4>
