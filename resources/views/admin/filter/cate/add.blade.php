...
@section('content')
<p>>Admin > Filter > Type > Register :</p>
<div class="row">
    <div class="col-xl-12 col-lg-12">
        <div class="card">
            <form method="post" action="{{ route ('dashboard.filter-cat.insert') }}" enctype="multipart-form-data">
                @csrf
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-3 text-end">
                                <label class="col-form-label input_name"> Filter Type Title <span class="err">*</span>
                                    :</label>
                            </div>
                            <div class="col-md-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-3 text-end">
                                <label class="col-form-label input_name"> Filter Button <span class="err">*</span>
                                    :</label>
                            </div>
                            <div class="col-md-5">
