    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card">
            <div class="card-header bg-dark">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card_header"><i class="fa-brands fa-servicestack header_icon"></i> All User </h3>
                    </div>
                    <div class="col-md-4 text-end"><a href="#"
                            class="btn btn-sm btn-primary btn_header">
                            <i class="fa-solid fa-user-plus"></i> Add User </a></div>
                </div>
            </div>
            <div class="row m-80">
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item"
                                                        href="{{ url ('dashboard/user/view/'.$data->tech_slug) }}">View</a>
                                                </li>

                                                <li><a class="dropdown-item"
                                                        href="{{ url ('dashboard/user/edit/'.$data->tech_slug) }}">Edit</a>
                                                </li>
