    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card">
            <div class="card-header bg-dark">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card_header"><i class="fa-brands fa-choosestack header_icon"></i> All Choose</h3>
                    </div>
                    <div class="col-md-4 text-end"><a href="{{ route('dashboard.choose.add') }}"
                            class="btn btn-sm btn-primary btn_header">
                            <i class="fa-solid fa-user-plus"></i> Add Choose</a></div>
                </div>
            </div>
            <div class="row m-80">
                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item"
                                                        href="{{ url ('dashboard/choose/view/'.$data->cho_slug) }}">View</a>
                                                </li>

                                                <li><a class="dropdown-item"
                                                        href="{{ url ('dashboard/choose/edit/'.$data->cho_slug) }}">Edit</a>
                                                </li>
...
<div id="softDelete_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel"
    ...
    <div class="modal-dialog">
        <form method="post" action="{{ route ('dashboard.choose.softdelete') }}">
            @csrf
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-warning">
                    <h4 class="modal-title" id="primary-header-modalLabel">Choose</h4>
