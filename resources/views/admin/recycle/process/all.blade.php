    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card">
            <div class="card-header bg-dark">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card_header"><i class="uil-envelope-alt header_icon"></i> All Deleted AI Process Type
                            Data
                        </h3>
                    </div>
                </div>
            ...
            <div class="row m-80">
                ...
                <div class="col-md-10">
                    <table id="myTable" class="table  table-striped text-center custom_table">
                        ...
                        @if($alprocess->count() > 0)
                                @foreach($alprocess as $data)
                                    <tr class="table_font">
                                        <td>{{ $data->pro_title }}</td>
                                        <td>{{ $data->pro_elem1 }}</td>
                                        <td>{{ $data->pro_elem2 }}</td>
                                    ...
                                    <div id="delete_modal" class="modal fade" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog">
                                            <form method="post"
                                                action="{{ url('/dashboard/process/delete/'.$data->pro_slug) }}">
                                                @method('DELETE')
                                                @csrf
                                                <div class="modal-content">
                                                    <div class="modal-header modal-colored-header bg-danger">
                                                        <h4 class="modal-title" id="primary-header-modalLabel">permanent
                                                            Delete AI Process Type</h4>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-hidden="true"></button>
                                                    </div>
                                                    <div class="modal-body modal_body">
                                                        Are You Sure want to Delete AI Process Type Data?
...
<div id="recover_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="primary-header-modalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <form method="post" action="{{ route('dashboard.process.restore') }}">
            @csrf
            <div class="modal-content">
                <div class="modal-header modal-colored-header bg-primary">
                    <h4 class="modal-title" id="primary-header-modalLabel">Recover AI Process Type Data</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
                </div>
                <div class="modal-body modal_body">
                    Are You Sure want to Restore AI Process Type Data?
