    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card">
            <div class="card-header bg-dark">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card_header"><i class="uil-envelope-alt header_icon"></i> All Deleted Technology
                        </h3>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            @foreach($technology as $data)
                                <tr class="table_font">
                                    ...
                                    <td>
                                        @if($data->tech_icon)
                                            <img src="{{ asset('uploads/admin/technology/'.$data->tech_icon) }}"
                                ...
                                <div id="delete_modal" class="modal fade" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog">
                                        <form method="post"
                                            action="{{ url('/dashboard/technology/delete/' .$data->tech_slug) }}">
                                            @method('DELETE')
                                            @csrf
                                            <div class="modal-content">
                                                <div class="modal-header modal-colored-header bg-danger">
                                                    <h4 class="modal-title" id="primary-header-modalLabel">permanent Delete Technology</h4>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-hidden="true"></button>
                                                </div>
                                                <div class="modal-body modal_body">
                                                    Are You Sure want to Delete Technology Data?
